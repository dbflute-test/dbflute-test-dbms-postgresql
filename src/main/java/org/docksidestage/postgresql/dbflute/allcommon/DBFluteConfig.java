...
public class DBFluteConfig {
    ...
    //                                   Database Dependency
    //                                   -------------------
    protected org.dbflute.dbway.topic.ExtensionOperand _fullTextSearchOperand
            = org.dbflute.dbway.WayOfPostgreSQL.OperandOfLikeSearch.PGROONGA_BASIC_FULL_TEXT_SEARCH;
    ...
    //                              ------------------------
    public org.dbflute.dbway.topic.ExtensionOperand getFullTextSearchOperand() {
        return _fullTextSearchOperand;
    }

    public void setFullTextSearchOperand(org.dbflute.dbway.topic.ExtensionOperand fullTextSearchOperand) {
        assertUnlocked();
        if (_log.isInfoEnabled()) {
            _log.info("...Setting fullTextSearchOperand: " + fullTextSearchOperand);
        }
        _fullTextSearchOperand = fullTextSearchOperand;
    }

    public void useFullTextSearchOperandMecabTextsearchJa() {
        assertUnlocked();
        if (_log.isInfoEnabled()) {
            _log.info("...Using fullTextSearchOperand: MecabTextsearchJa");
        }
        _fullTextSearchOperand = org.dbflute.dbway.WayOfPostgreSQL.OperandOfLikeSearch.MECAB_TEXTSEARCH_JA_FULL_TEXT_SEARCH;
    }

    public void useFullTextSearchOperandPGroongaBasic() {
        assertUnlocked();
        if (_log.isInfoEnabled()) {
            _log.info("...Using fullTextSearchOperand: PGroongaBasic");
        }
        _fullTextSearchOperand = org.dbflute.dbway.WayOfPostgreSQL.OperandOfLikeSearch.PGROONGA_BASIC_FULL_TEXT_SEARCH;
    }

    public void useFullTextSearchOperanTraditionalNewFullTextSearch() {
        assertUnlocked();
        if (_log.isInfoEnabled()) {
            _log.info("...Using fullTextSearchOperand: traditional new FullTextSearch");
        }
        _fullTextSearchOperand = org.dbflute.dbway.WayOfPostgreSQL.OperandOfLikeSearch.FULL_TEXT_SEARCH;
    }

    public void useFullTextSearchOperanTraditionalOldFullTextSearch() {
        assertUnlocked();
        if (_log.isInfoEnabled()) {
            _log.info("...Using fullTextSearchOperand: traditional old FullTextSearch");
        }
        _fullTextSearchOperand = org.dbflute.dbway.WayOfPostgreSQL.OperandOfLikeSearch.OLD_FULL_TEXT_SEARCH;
    }

    @Deprecated // removal in the future, since 1.2.7
