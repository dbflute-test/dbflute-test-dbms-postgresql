...
public abstract class BsNextSchemaProductBhv extends AbstractBehaviorWritable<NextSchemaProduct, NextSchemaProductCB> {
     ...
     * <pre>
     * nextSchemaProductBhv.<span style="color: #DD4747">loadWhiteSameNameList</span>(nextSchemaProductList, nameCB -&gt; {
     *     nameCB.setupSelect...();
     *     nameCB.query().setFoo...(value);
     *     nameCB.query().addOrderBy_Bar...();
