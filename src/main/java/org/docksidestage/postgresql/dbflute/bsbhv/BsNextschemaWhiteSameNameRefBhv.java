...
public abstract class BsNextschemaWhiteSameNameRefBhv extends AbstractBehaviorWritable<NextschemaWhiteSameNameRef, NextschemaWhiteSameNameRefCB> {
     ...
     * @exception EntityAlreadyExistsException When the entity already exists. (unique constraint violation)
     */
    public void varyingInsert(NextschemaWhiteSameNameRef whiteSameNameRef, WOptionCall<NextschemaWhiteSameNameRefCB, InsertOption<NextschemaWhiteSameNameRefCB>> opLambda) {
     ...
     * @exception EntityAlreadyExistsException When the entity already exists. (unique constraint violation)
     */
    public void varyingUpdate(NextschemaWhiteSameNameRef whiteSameNameRef, WOptionCall<NextschemaWhiteSameNameRefCB, UpdateOption<NextschemaWhiteSameNameRefCB>> opLambda) {
     ...
     * @exception EntityAlreadyExistsException When the entity already exists. (unique constraint violation)
     */
    public void varyingInsertOrUpdate(NextschemaWhiteSameNameRef whiteSameNameRef, WOptionCall<NextschemaWhiteSameNameRefCB, InsertOption<NextschemaWhiteSameNameRefCB>> insertOpLambda, WOptionCall<NextschemaWhiteSameNameRefCB, UpdateOption<NextschemaWhiteSameNameRefCB>> updateOpLambda) {
     ...
     * @exception EntityDuplicatedException When the entity has been duplicated.
     */
    public void varyingDelete(NextschemaWhiteSameNameRef whiteSameNameRef, WOptionCall<NextschemaWhiteSameNameRefCB, DeleteOption<NextschemaWhiteSameNameRefCB>> opLambda) {
     ...
     * @return The array of updated count. (NotNull, EmptyAllowed)
     */
    public int[] varyingBatchInsert(List<NextschemaWhiteSameNameRef> whiteSameNameRefList, WOptionCall<NextschemaWhiteSameNameRefCB, InsertOption<NextschemaWhiteSameNameRefCB>> opLambda) {
     ...
     * @return The array of updated count. (NotNull, EmptyAllowed)
     */
    public int[] varyingBatchUpdate(List<NextschemaWhiteSameNameRef> whiteSameNameRefList, WOptionCall<NextschemaWhiteSameNameRefCB, UpdateOption<NextschemaWhiteSameNameRefCB>> opLambda) {
     ...
     * @return The array of deleted count. (NotNull, EmptyAllowed)
     */
    public int[] varyingBatchDelete(List<NextschemaWhiteSameNameRef> whiteSameNameRefList, WOptionCall<NextschemaWhiteSameNameRefCB, DeleteOption<NextschemaWhiteSameNameRefCB>> opLambda) {
     ...
     * @return The inserted count.
     */
    public int varyingQueryInsert(QueryInsertSetupper<NextschemaWhiteSameNameRef, NextschemaWhiteSameNameRefCB> manyArgLambda, WOptionCall<NextschemaWhiteSameNameRefCB, InsertOption<NextschemaWhiteSameNameRefCB>> opLambda) {
     ...
     */
    public int varyingQueryUpdate(NextschemaWhiteSameNameRef whiteSameNameRef, CBCall<NextschemaWhiteSameNameRefCB> cbLambda, WOptionCall<NextschemaWhiteSameNameRefCB, UpdateOption<NextschemaWhiteSameNameRefCB>> opLambda) {
     ...
     * @exception NonQueryUpdateNotAllowedException When the query has no condition (if not allowed).
     */
    public int varyingQueryUpdate(NextschemaWhiteSameNameRef whiteSameNameRef, NextschemaWhiteSameNameRefCB cb, WOptionCall<NextschemaWhiteSameNameRefCB, UpdateOption<NextschemaWhiteSameNameRefCB>> opLambda) {
     ...
     */
    public int varyingQueryDelete(CBCall<NextschemaWhiteSameNameRefCB> cbLambda, WOptionCall<NextschemaWhiteSameNameRefCB, DeleteOption<NextschemaWhiteSameNameRefCB>> opLambda) {
     ...
     * @exception NonQueryDeleteNotAllowedException When the query has no condition (if not allowed).
     */
    public int varyingQueryDelete(NextschemaWhiteSameNameRefCB cb, WOptionCall<NextschemaWhiteSameNameRefCB, DeleteOption<NextschemaWhiteSameNameRefCB>> opLambda) {
