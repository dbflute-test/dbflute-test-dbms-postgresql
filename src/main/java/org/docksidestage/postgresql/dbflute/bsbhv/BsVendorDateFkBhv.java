...
public abstract class BsVendorDateFkBhv extends AbstractBehaviorWritable<VendorDateFk, VendorDateFkCB> {
     ...
     * <pre>
     * int count = <span style="color: #0000C0">vendorDateFkBhv</span>.<span style="color: #CC4747">selectCount</span>(<span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     * int count = <span style="color: #0000C0">vendorDateFkBhv</span>.<span style="color: #CC4747">selectCount</span>(cb);
     * </pre>
     ...
     * });
     * for (VendorDateFk <span style="color: #553000">vendorDateFk</span> : <span style="color: #553000">vendorDateFkList</span>) {
     ...
     * for (VendorDateFk vendorDateFk : <span style="color: #553000">vendorDateFkList</span>) {
     *     ... = vendorDateFk.get...();
     * }
     * </pre>
     * @param cb The condition-bean of VendorDateFk. (NotNull)
     ...
     * ...
     * for (VendorDateFk vendorDateFk : <span style="color: #553000">page</span>) {
     *     ... = vendorDateFk.get...();
     * }
     * </pre>
     * @param cbLambda The callback for condition-bean of VendorDateFk. (NotNull)
     ...
     * VendorDateFkCB cb = new VendorDateFkCB();
     * cb.query().set...
     * <span style="color: #0000C0">vendorDateFkBhv</span>.<span style="color: #CC4747">selectCursor</span>(cb, new EntityRowHandler&lt;VendorDateFk&gt;() {
