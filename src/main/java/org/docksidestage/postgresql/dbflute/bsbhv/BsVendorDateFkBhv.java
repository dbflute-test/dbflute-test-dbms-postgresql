...
public abstract class BsVendorDateFkBhv extends AbstractBehaviorWritable<VendorDateFk, VendorDateFkCB> {
     ...
     * int count = vendorDateFkBhv.<span style="color: #CC4747">selectCount</span>(cb);
     * </pre>
     ...
     * <pre>
     * VendorDateFk vendorDateFk = vendorDateFkBhv.<span style="color: #CC4747">selectEntity</span>(cb -&gt; {
     *     cb.query().set...
     * });
     ...
     * VendorDateFkCB cb = new VendorDateFkCB();
     * cb.query().setFoo...(value);
     * VendorDateFk vendorDateFk = vendorDateFkBhv.<span style="color: #CC4747">selectEntityWithDeletedCheck</span>(cb);
     ...
     * <pre>
     * ListResultBean&lt;VendorDateFk&gt; vendorDateFkList = vendorDateFkBhv.<span style="color: #CC4747">selectList</span>(cb -&gt; {
     *     cb.query().set...;
     *     cb.query().addOrderBy...;
     * });
     * vendorDateFkList.forEach(vendorDateFk -&gt; {
     *     ... = vendorDateFk.get...();
     * });
     * </pre>
     * @param cbLambda The callback for condition-bean of VendorDateFk. (NotNull)
     ...
     * PagingResultBean&lt;VendorDateFk&gt; page = vendorDateFkBhv.<span style="color: #CC4747">selectPage</span>(cb);
     ...
     * VendorDateFkCB cb = new VendorDateFkCB();
     * cb.query().setFoo...(value);
     * vendorDateFkBhv.<span style="color: #CC4747">selectCursor</span>(cb, new EntityRowHandler&lt;VendorDateFk&gt;() {
     ...
     * <pre>
     * vendorDateFkBhv.<span style="color: #CC4747">scalarSelect</span>(Date.class).max(new ScalarQuery() {
     ...
     * vendorDateFkBhv.<span style="color: #CC4747">insert</span>(vendorDateFk);
     ...
     * try {
     *     vendorDateFkBhv.<span style="color: #CC4747">update</span>(vendorDateFk);
     ...
     * vendorDateFk.<span style="color: #CC4747">setVersionNo</span>(value);
     * try {
     *     vendorDateFkBhv.<span style="color: #CC4747">delete</span>(vendorDateFk);
     * } catch (EntityAlreadyUpdatedException e) { <span style="color: #3F7E5E">// if concurrent update</span>
     *     ...
     * }
     * </pre>
     ...
     * }
     * vendorDateFkBhv.<span style="color: #CC4747">batchInsert</span>(vendorDateFkList);
     * </pre>
     ...
     *     vendorDateFkList.add(vendorDateFk);
     * }
     * vendorDateFkBhv.<span style="color: #CC4747">batchUpdate</span>(vendorDateFkList);
     * </pre>
     ...
     * <pre>
     * vendorDateFkBhv.<span style="color: #CC4747">queryInsert</span>(new QueryInsertSetupper&lt;VendorDateFk, VendorDateFkCB&gt;() {
     ...
     * VendorDateFkCB cb = new VendorDateFkCB();
     * cb.query().setFoo...(value);
     * vendorDateFkBhv.<span style="color: #CC4747">queryUpdate</span>(vendorDateFk, cb);
     * </pre>
     ...
     * VendorDateFkCB cb = new VendorDateFkCB();
     * cb.query().setFoo...(value);
     * vendorDateFkBhv.<span style="color: #CC4747">queryDelete</span>(vendorDateFk, cb);
     * </pre>
     * @param cbLambda The callback for condition-bean of VendorDateFk. (NotNull)
     ...
     * vendorDateFkBhv.<span style="color: #CC4747">varyingInsert</span>(vendorDateFk, option);
     * ... = vendorDateFk.getPK...(); <span style="color: #3F7E5E">// if auto-increment, you can get the value after</span>
     * </pre>
     * @param vendorDateFk The entity of insert. (NotNull, PrimaryKeyNullAllowed: when auto-increment)
     ...
     *     vendorDateFkBhv.<span style="color: #CC4747">varyingUpdate</span>(vendorDateFk, option);
     * } catch (EntityAlreadyUpdatedException e) { <span style="color: #3F7E5E">// if concurrent update</span>
     *     ...
     * }
     * </pre>
     ...
     * vendorDateFkBhv.<span style="color: #CC4747">varyingQueryUpdate</span>(vendorDateFk, cb, option);
     * </pre>
