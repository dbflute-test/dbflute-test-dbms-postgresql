...
public abstract class BsVendorDatePkBhv extends AbstractBehaviorWritable<VendorDatePk, VendorDatePkCB> {
     ...
     * <pre>
     * int count = <span style="color: #0000C0">vendorDatePkBhv</span>.<span style="color: #CC4747">selectCount</span>(<span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     * int count = <span style="color: #0000C0">vendorDatePkBhv</span>.<span style="color: #CC4747">selectCount</span>(cb);
     * </pre>
     ...
     * });
     * for (VendorDatePk <span style="color: #553000">vendorDatePk</span> : <span style="color: #553000">vendorDatePkList</span>) {
     ...
     * ...
     * for (VendorDatePk vendorDatePk : <span style="color: #553000">page</span>) {
     *     ... = vendorDatePk.get...();
     * }
     * </pre>
     * @param cbLambda The callback for condition-bean of VendorDatePk. (NotNull)
     ...
     * VendorDatePkCB cb = new VendorDatePkCB();
     * cb.query().set...
     * <span style="color: #0000C0">vendorDatePkBhv</span>.<span style="color: #CC4747">selectCursor</span>(cb, new EntityRowHandler&lt;VendorDatePk&gt;() {
