...
public abstract class BsVendorInheritInuBhv extends AbstractBehaviorWritable<VendorInheritInu, VendorInheritInuCB> {
     ...
     * int count = vendorInheritInuBhv.<span style="color: #CC4747">selectCount</span>(cb);
     * </pre>
     ...
     * <pre>
     * VendorInheritInu vendorInheritInu = vendorInheritInuBhv.<span style="color: #CC4747">selectEntity</span>(cb -&gt; {
     *     cb.query().set...
     * });
     ...
     * VendorInheritInuCB cb = new VendorInheritInuCB();
     * cb.query().setFoo...(value);
     * VendorInheritInu vendorInheritInu = vendorInheritInuBhv.<span style="color: #CC4747">selectEntityWithDeletedCheck</span>(cb);
     ...
     * <pre>
     * ListResultBean&lt;VendorInheritInu&gt; vendorInheritInuList = vendorInheritInuBhv.<span style="color: #CC4747">selectList</span>(cb -&gt; {
     *     cb.query().set...;
     *     cb.query().addOrderBy...;
     * });
     * vendorInheritInuList.forEach(vendorInheritInu -&gt; {
     *     ... = vendorInheritInu.get...();
     * });
     * </pre>
     * @param cbLambda The callback for condition-bean of VendorInheritInu. (NotNull)
     ...
     * PagingResultBean&lt;VendorInheritInu&gt; page = vendorInheritInuBhv.<span style="color: #CC4747">selectPage</span>(cb);
     ...
     * VendorInheritInuCB cb = new VendorInheritInuCB();
     * cb.query().setFoo...(value);
     * vendorInheritInuBhv.<span style="color: #CC4747">selectCursor</span>(cb, new EntityRowHandler&lt;VendorInheritInu&gt;() {
     ...
     * <pre>
     * vendorInheritInuBhv.<span style="color: #CC4747">scalarSelect</span>(Date.class).max(new ScalarQuery() {
     ...
     * vendorInheritInuBhv.<span style="color: #CC4747">insert</span>(vendorInheritInu);
     ...
     * try {
     *     vendorInheritInuBhv.<span style="color: #CC4747">update</span>(vendorInheritInu);
     ...
     * vendorInheritInu.<span style="color: #CC4747">setVersionNo</span>(value);
     * try {
     *     vendorInheritInuBhv.<span style="color: #CC4747">delete</span>(vendorInheritInu);
     * } catch (EntityAlreadyUpdatedException e) { <span style="color: #3F7E5E">// if concurrent update</span>
     *     ...
     * }
     * </pre>
     ...
     * }
     * vendorInheritInuBhv.<span style="color: #CC4747">batchInsert</span>(vendorInheritInuList);
     * </pre>
     ...
     *     vendorInheritInuList.add(vendorInheritInu);
     * }
     * vendorInheritInuBhv.<span style="color: #CC4747">batchUpdate</span>(vendorInheritInuList);
     * </pre>
     ...
     * <pre>
     * vendorInheritInuBhv.<span style="color: #CC4747">queryInsert</span>(new QueryInsertSetupper&lt;VendorInheritInu, VendorInheritInuCB&gt;() {
     ...
     * VendorInheritInuCB cb = new VendorInheritInuCB();
     * cb.query().setFoo...(value);
     * vendorInheritInuBhv.<span style="color: #CC4747">queryUpdate</span>(vendorInheritInu, cb);
     * </pre>
     ...
     * VendorInheritInuCB cb = new VendorInheritInuCB();
     * cb.query().setFoo...(value);
     * vendorInheritInuBhv.<span style="color: #CC4747">queryDelete</span>(vendorInheritInu, cb);
     * </pre>
     * @param cbLambda The callback for condition-bean of VendorInheritInu. (NotNull)
     ...
     * vendorInheritInuBhv.<span style="color: #CC4747">varyingInsert</span>(vendorInheritInu, option);
     * ... = vendorInheritInu.getPK...(); <span style="color: #3F7E5E">// if auto-increment, you can get the value after</span>
     * </pre>
     * @param vendorInheritInu The entity of insert. (NotNull, PrimaryKeyNullAllowed: when auto-increment)
     ...
     *     vendorInheritInuBhv.<span style="color: #CC4747">varyingUpdate</span>(vendorInheritInu, option);
     * } catch (EntityAlreadyUpdatedException e) { <span style="color: #3F7E5E">// if concurrent update</span>
     *     ...
     * }
     * </pre>
     ...
     * vendorInheritInuBhv.<span style="color: #CC4747">varyingQueryUpdate</span>(vendorInheritInu, cb, option);
     * </pre>
