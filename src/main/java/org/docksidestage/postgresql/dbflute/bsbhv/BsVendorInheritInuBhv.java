...
public abstract class BsVendorInheritInuBhv extends AbstractBehaviorWritable<VendorInheritInu, VendorInheritInuCB> {
     ...
     * <pre>
     * int count = <span style="color: #0000C0">vendorInheritInuBhv</span>.<span style="color: #CC4747">selectCount</span>(<span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     * int count = <span style="color: #0000C0">vendorInheritInuBhv</span>.<span style="color: #CC4747">selectCount</span>(cb);
     * </pre>
     ...
     * });
     * for (VendorInheritInu <span style="color: #553000">vendorInheritInu</span> : <span style="color: #553000">vendorInheritInuList</span>) {
     ...
     * for (VendorInheritInu vendorInheritInu : <span style="color: #553000">vendorInheritInuList</span>) {
     *     ... = vendorInheritInu.get...();
     * }
     * </pre>
     * @param cb The condition-bean of VendorInheritInu. (NotNull)
     ...
     * ...
     * for (VendorInheritInu vendorInheritInu : <span style="color: #553000">page</span>) {
     *     ... = vendorInheritInu.get...();
     * }
     * </pre>
     * @param cbLambda The callback for condition-bean of VendorInheritInu. (NotNull)
     ...
     * VendorInheritInuCB cb = new VendorInheritInuCB();
     * cb.query().set...
     * <span style="color: #0000C0">vendorInheritInuBhv</span>.<span style="color: #CC4747">selectCursor</span>(cb, new EntityRowHandler&lt;VendorInheritInu&gt;() {
