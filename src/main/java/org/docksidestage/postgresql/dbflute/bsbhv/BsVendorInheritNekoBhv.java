...
public abstract class BsVendorInheritNekoBhv extends AbstractBehaviorWritable<VendorInheritNeko, VendorInheritNekoCB> {
     ...
     * <pre>
     * int count = <span style="color: #0000C0">vendorInheritNekoBhv</span>.<span style="color: #CC4747">selectCount</span>(<span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     * int count = <span style="color: #0000C0">vendorInheritNekoBhv</span>.<span style="color: #CC4747">selectCount</span>(cb);
     * </pre>
     ...
     * });
     * for (VendorInheritNeko <span style="color: #553000">vendorInheritNeko</span> : <span style="color: #553000">vendorInheritNekoList</span>) {
     ...
     * for (VendorInheritNeko vendorInheritNeko : <span style="color: #553000">vendorInheritNekoList</span>) {
     *     ... = vendorInheritNeko.get...();
     * }
     * </pre>
     * @param cb The condition-bean of VendorInheritNeko. (NotNull)
     ...
     * ...
     * for (VendorInheritNeko vendorInheritNeko : <span style="color: #553000">page</span>) {
     *     ... = vendorInheritNeko.get...();
     * }
     * </pre>
     * @param cbLambda The callback for condition-bean of VendorInheritNeko. (NotNull)
     ...
     * VendorInheritNekoCB cb = new VendorInheritNekoCB();
     * cb.query().set...
     * <span style="color: #0000C0">vendorInheritNekoBhv</span>.<span style="color: #CC4747">selectCursor</span>(cb, new EntityRowHandler&lt;VendorInheritNeko&gt;() {
