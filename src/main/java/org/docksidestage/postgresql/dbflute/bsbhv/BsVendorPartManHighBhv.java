...
public abstract class BsVendorPartManHighBhv extends AbstractBehaviorWritable<VendorPartManHigh, VendorPartManHighCB> {
     ...
     * int count = vendorPartManHighBhv.<span style="color: #CC4747">selectCount</span>(cb);
     * </pre>
     ...
     * <pre>
     * VendorPartManHigh vendorPartManHigh = vendorPartManHighBhv.<span style="color: #CC4747">selectEntity</span>(cb -&gt; {
     *     cb.query().set...
     * });
     ...
     * VendorPartManHighCB cb = new VendorPartManHighCB();
     * cb.query().setFoo...(value);
     * VendorPartManHigh vendorPartManHigh = vendorPartManHighBhv.<span style="color: #CC4747">selectEntityWithDeletedCheck</span>(cb);
     ...
     * <pre>
     * ListResultBean&lt;VendorPartManHigh&gt; vendorPartManHighList = vendorPartManHighBhv.<span style="color: #CC4747">selectList</span>(cb -&gt; {
     *     cb.query().set...;
     *     cb.query().addOrderBy...;
     * });
     * vendorPartManHighList.forEach(vendorPartManHigh -&gt; {
     *     ... = vendorPartManHigh.get...();
     * });
     * </pre>
     * @param cbLambda The callback for condition-bean of VendorPartManHigh. (NotNull)
     ...
     * PagingResultBean&lt;VendorPartManHigh&gt; page = vendorPartManHighBhv.<span style="color: #CC4747">selectPage</span>(cb);
     ...
     * VendorPartManHighCB cb = new VendorPartManHighCB();
     * cb.query().setFoo...(value);
     * vendorPartManHighBhv.<span style="color: #CC4747">selectCursor</span>(cb, new EntityRowHandler&lt;VendorPartManHigh&gt;() {
     ...
     * <pre>
     * vendorPartManHighBhv.<span style="color: #CC4747">scalarSelect</span>(Date.class).max(new ScalarQuery() {
     ...
     * vendorPartManHighBhv.<span style="color: #CC4747">insert</span>(vendorPartManHigh);
     ...
     * try {
     *     vendorPartManHighBhv.<span style="color: #CC4747">update</span>(vendorPartManHigh);
     ...
     * vendorPartManHigh.<span style="color: #CC4747">setVersionNo</span>(value);
     * try {
     *     vendorPartManHighBhv.<span style="color: #CC4747">delete</span>(vendorPartManHigh);
     * } catch (EntityAlreadyUpdatedException e) { <span style="color: #3F7E5E">// if concurrent update</span>
     *     ...
     * }
     * </pre>
     ...
     * }
     * vendorPartManHighBhv.<span style="color: #CC4747">batchInsert</span>(vendorPartManHighList);
     * </pre>
     ...
     *     vendorPartManHighList.add(vendorPartManHigh);
     * }
     * vendorPartManHighBhv.<span style="color: #CC4747">batchUpdate</span>(vendorPartManHighList);
     * </pre>
     ...
     * <pre>
     * vendorPartManHighBhv.<span style="color: #CC4747">queryInsert</span>(new QueryInsertSetupper&lt;VendorPartManHigh, VendorPartManHighCB&gt;() {
     ...
     * VendorPartManHighCB cb = new VendorPartManHighCB();
     * cb.query().setFoo...(value);
     * vendorPartManHighBhv.<span style="color: #CC4747">queryUpdate</span>(vendorPartManHigh, cb);
     * </pre>
     ...
     * VendorPartManHighCB cb = new VendorPartManHighCB();
     * cb.query().setFoo...(value);
     * vendorPartManHighBhv.<span style="color: #CC4747">queryDelete</span>(vendorPartManHigh, cb);
     * </pre>
     * @param cbLambda The callback for condition-bean of VendorPartManHigh. (NotNull)
     ...
     * vendorPartManHighBhv.<span style="color: #CC4747">varyingInsert</span>(vendorPartManHigh, option);
     * ... = vendorPartManHigh.getPK...(); <span style="color: #3F7E5E">// if auto-increment, you can get the value after</span>
     * </pre>
     * @param vendorPartManHigh The entity of insert. (NotNull, PrimaryKeyNullAllowed: when auto-increment)
     ...
     *     vendorPartManHighBhv.<span style="color: #CC4747">varyingUpdate</span>(vendorPartManHigh, option);
     * } catch (EntityAlreadyUpdatedException e) { <span style="color: #3F7E5E">// if concurrent update</span>
     *     ...
     * }
     * </pre>
     ...
     * vendorPartManHighBhv.<span style="color: #CC4747">varyingQueryUpdate</span>(vendorPartManHigh, cb, option);
     * </pre>
