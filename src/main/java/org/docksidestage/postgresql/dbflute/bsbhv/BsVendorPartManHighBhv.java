...
public abstract class BsVendorPartManHighBhv extends AbstractBehaviorWritable<VendorPartManHigh, VendorPartManHighCB> {
     ...
     * <pre>
     * int count = <span style="color: #0000C0">vendorPartManHighBhv</span>.<span style="color: #CC4747">selectCount</span>(<span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     * int count = <span style="color: #0000C0">vendorPartManHighBhv</span>.<span style="color: #CC4747">selectCount</span>(cb);
     * </pre>
     ...
     * <pre>
     * VendorPartManHigh vendorPartManHigh = <span style="color: #0000C0">vendorPartManHighBhv</span>.<span style="color: #CC4747">selectEntity</span>(<span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">cb</span>.query().set...
     * });
     ...
     * VendorPartManHighCB cb = new VendorPartManHighCB();
     * cb.query().setFoo...(value);
     * VendorPartManHigh vendorPartManHigh = <span style="color: #0000C0">vendorPartManHighBhv</span>.<span style="color: #DD4747">selectEntity</span>(cb);
     * if (vendorPartManHigh != null) { <span style="color: #3F7E5E">// null check</span>
     *     ... = vendorPartManHigh.get...();
     * } else {
     *     ...
     ...
     * });
     * for (VendorPartManHigh <span style="color: #553000">vendorPartManHigh</span> : <span style="color: #553000">vendorPartManHighList</span>) {
     ...
     * for (VendorPartManHigh vendorPartManHigh : <span style="color: #553000">vendorPartManHighList</span>) {
     *     ... = vendorPartManHigh.get...();
     * }
     * </pre>
     * @param cb The condition-bean of VendorPartManHigh. (NotNull)
     ...
     * ...
     * for (VendorPartManHigh vendorPartManHigh : <span style="color: #553000">page</span>) {
     *     ... = vendorPartManHigh.get...();
     * }
     * </pre>
     * @param cbLambda The callback for condition-bean of VendorPartManHigh. (NotNull)
     ...
     * VendorPartManHighCB cb = new VendorPartManHighCB();
     * cb.query().set...
     * <span style="color: #0000C0">vendorPartManHighBhv</span>.<span style="color: #CC4747">selectCursor</span>(cb, new EntityRowHandler&lt;VendorPartManHigh&gt;() {
     ...
     * <pre>
     * <span style="color: #0000C0">vendorPartManHighBhv</span>.<span style="color: #CC4747">scalarSelect</span>(Date.class).max(<span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     * <span style="color: #0000C0">vendorPartManHighBhv</span>.<span style="color: #CC4747">varyingInsert</span>(vendorPartManHigh, option);
     * ... = vendorPartManHigh.getPK...(); <span style="color: #3F7E5E">// if auto-increment, you can get the value after</span>
     * </pre>
     * @param vendorPartManHigh The entity of insert. (NotNull, PrimaryKeyNullAllowed: when auto-increment)
     ...
     *     <span style="color: #0000C0">vendorPartManHighBhv</span>.<span style="color: #CC4747">varyingUpdate</span>(vendorPartManHigh, option);
     * } catch (EntityAlreadyUpdatedException e) { <span style="color: #3F7E5E">// if concurrent update</span>
     *     ...
     * }
     * </pre>
     ...
     * <span style="color: #0000C0">vendorPartManHighBhv</span>.<span style="color: #CC4747">varyingQueryUpdate</span>(vendorPartManHigh, cb, option);
     * </pre>
