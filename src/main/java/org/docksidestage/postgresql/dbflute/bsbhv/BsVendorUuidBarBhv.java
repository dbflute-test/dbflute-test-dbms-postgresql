...
public abstract class BsVendorUuidBarBhv extends AbstractBehaviorWritable<VendorUuidBar, VendorUuidBarCB> {
     ...
     * <pre>
     * vendorUuidBarBhv.<span style="color: #DD4747">loadVendorUuidFooList</span>(vendorUuidBarList, fooCB -&gt; {
     *     fooCB.setupSelect...();
     *     fooCB.query().setFoo...(value);
     *     fooCB.query().addOrderBy_Bar...();
    ...
    public int queryUpdate(VendorUuidBar vendorUuidBar, CBCall<VendorUuidBarCB> cbLambda) {
        return doQueryUpdate(vendorUuidBar, handleCBCall(cbLambda), null);
    }
     ...
     * @exception EntityAlreadyExistsException When the entity already exists. (unique constraint violation)
     */
    public void varyingInsert(VendorUuidBar vendorUuidBar, WOptionCall<VendorUuidBarCB, InsertOption<VendorUuidBarCB>> opLambda) {
        doInsert(vendorUuidBar, handleInsertOpCall(opLambda));
    }
     ...
     * @exception EntityAlreadyExistsException When the entity already exists. (unique constraint violation)
     */
    public void varyingUpdate(VendorUuidBar vendorUuidBar, WOptionCall<VendorUuidBarCB, UpdateOption<VendorUuidBarCB>> opLambda) {
        doUpdate(vendorUuidBar, handleUpdateOpCall(opLambda));
    }
     ...
     * @exception EntityAlreadyExistsException When the entity already exists. (unique constraint violation)
     */
    public void varyingInsertOrUpdate(VendorUuidBar vendorUuidBar, WOptionCall<VendorUuidBarCB, InsertOption<VendorUuidBarCB>> insertOpLambda, WOptionCall<VendorUuidBarCB, UpdateOption<VendorUuidBarCB>> updateOpLambda) {
        doInsertOrUpdate(vendorUuidBar, handleInsertOpCall(insertOpLambda), handleUpdateOpCall(updateOpLambda));
    }
     ...
     * @exception EntityDuplicatedException When the entity has been duplicated.
     */
    public void varyingDelete(VendorUuidBar vendorUuidBar, WOptionCall<VendorUuidBarCB, DeleteOption<VendorUuidBarCB>> opLambda) {
        doDelete(vendorUuidBar, handleDeleteOpCall(opLambda));
    }
     ...
     * @return The array of updated count. (NotNull, EmptyAllowed)
     */
    public int[] varyingBatchInsert(List<VendorUuidBar> vendorUuidBarList, WOptionCall<VendorUuidBarCB, InsertOption<VendorUuidBarCB>> opLambda) {
        return doBatchInsert(vendorUuidBarList, handleInsertOpCall(opLambda));
    }
     ...
     * @return The array of updated count. (NotNull, EmptyAllowed)
     */
    public int[] varyingBatchUpdate(List<VendorUuidBar> vendorUuidBarList, WOptionCall<VendorUuidBarCB, UpdateOption<VendorUuidBarCB>> opLambda) {
        return doBatchUpdate(vendorUuidBarList, handleUpdateOpCall(opLambda));
    }
     ...
     * @return The array of deleted count. (NotNull, EmptyAllowed)
     */
    public int[] varyingBatchDelete(List<VendorUuidBar> vendorUuidBarList, WOptionCall<VendorUuidBarCB, DeleteOption<VendorUuidBarCB>> opLambda) {
        return doBatchDelete(vendorUuidBarList, handleDeleteOpCall(opLambda));
    }
     ...
     * @return The inserted count.
     */
    public int varyingQueryInsert(QueryInsertSetupper<VendorUuidBar, VendorUuidBarCB> manyArgLambda, WOptionCall<VendorUuidBarCB, InsertOption<VendorUuidBarCB>> opLambda) {
     ...
     */
    public int varyingQueryUpdate(VendorUuidBar vendorUuidBar, CBCall<VendorUuidBarCB> cbLambda, WOptionCall<VendorUuidBarCB, UpdateOption<VendorUuidBarCB>> opLambda) {
        return doQueryUpdate(vendorUuidBar, handleCBCall(cbLambda), handleUpdateOpCall(opLambda));
    }
     ...
     * @exception NonQueryUpdateNotAllowedException When the query has no condition (if not allowed).
     */
    public int varyingQueryUpdate(VendorUuidBar vendorUuidBar, VendorUuidBarCB cb, WOptionCall<VendorUuidBarCB, UpdateOption<VendorUuidBarCB>> opLambda) {
        return doQueryUpdate(vendorUuidBar, cb, handleUpdateOpCall(opLambda));
    }
     ...
     */
    public int varyingQueryDelete(CBCall<VendorUuidBarCB> cbLambda, WOptionCall<VendorUuidBarCB, DeleteOption<VendorUuidBarCB>> opLambda) {
     ...
     * @exception NonQueryDeleteNotAllowedException When the query has no condition (if not allowed).
     */
    public int varyingQueryDelete(VendorUuidBarCB cb, WOptionCall<VendorUuidBarCB, DeleteOption<VendorUuidBarCB>> opLambda) {
