...
public abstract class BsVendorUuidBarBhv extends AbstractBehaviorWritable<VendorUuidBar, VendorUuidBarCB> {
     ...
     * int count = vendorUuidBarBhv.<span style="color: #CC4747">selectCount</span>(cb);
     * </pre>
     ...
     * <pre>
     * VendorUuidBar vendorUuidBar = vendorUuidBarBhv.<span style="color: #CC4747">selectEntity</span>(cb -&gt; {
     *     cb.query().set...
     * });
     ...
     * VendorUuidBarCB cb = new VendorUuidBarCB();
     * cb.query().setFoo...(value);
     * VendorUuidBar vendorUuidBar = vendorUuidBarBhv.<span style="color: #CC4747">selectEntityWithDeletedCheck</span>(cb);
     ...
     * <pre>
     * ListResultBean&lt;VendorUuidBar&gt; vendorUuidBarList = vendorUuidBarBhv.<span style="color: #CC4747">selectList</span>(cb -&gt; {
     *     cb.query().set...;
     *     cb.query().addOrderBy...;
     * });
     * vendorUuidBarList.forEach(vendorUuidBar -&gt; {
     *     ... = vendorUuidBar.get...();
     * });
     * </pre>
     * @param cbLambda The callback for condition-bean of VendorUuidBar. (NotNull)
     ...
     * PagingResultBean&lt;VendorUuidBar&gt; page = vendorUuidBarBhv.<span style="color: #CC4747">selectPage</span>(cb);
     ...
     * VendorUuidBarCB cb = new VendorUuidBarCB();
     * cb.query().setFoo...(value);
     * vendorUuidBarBhv.<span style="color: #CC4747">selectCursor</span>(cb, new EntityRowHandler&lt;VendorUuidBar&gt;() {
     ...
     * <pre>
     * vendorUuidBarBhv.<span style="color: #CC4747">scalarSelect</span>(Date.class).max(new ScalarQuery() {
     ...
     * <pre>
     * vendorUuidBarBhv.<span style="color: #CC4747">loadVendorUuidFooList</span>(vendorUuidBarList, fooCB -&gt; {
     *     fooCB.setupSelect...();
     ...
     * vendorUuidBarBhv.<span style="color: #CC4747">insert</span>(vendorUuidBar);
     ...
     * try {
     *     vendorUuidBarBhv.<span style="color: #CC4747">update</span>(vendorUuidBar);
     ...
     * vendorUuidBar.<span style="color: #CC4747">setVersionNo</span>(value);
     * try {
     *     vendorUuidBarBhv.<span style="color: #CC4747">delete</span>(vendorUuidBar);
     * } catch (EntityAlreadyUpdatedException e) { <span style="color: #3F7E5E">// if concurrent update</span>
     *     ...
     * }
     * </pre>
     ...
     * }
     * vendorUuidBarBhv.<span style="color: #CC4747">batchInsert</span>(vendorUuidBarList);
     * </pre>
     ...
     *     vendorUuidBarList.add(vendorUuidBar);
     * }
     * vendorUuidBarBhv.<span style="color: #CC4747">batchUpdate</span>(vendorUuidBarList);
     * </pre>
     ...
     * <pre>
     * vendorUuidBarBhv.<span style="color: #CC4747">queryInsert</span>(new QueryInsertSetupper&lt;VendorUuidBar, VendorUuidBarCB&gt;() {
     ...
     * VendorUuidBarCB cb = new VendorUuidBarCB();
     * cb.query().setFoo...(value);
     * vendorUuidBarBhv.<span style="color: #CC4747">queryUpdate</span>(vendorUuidBar, cb);
     * </pre>
     ...
     * VendorUuidBarCB cb = new VendorUuidBarCB();
     * cb.query().setFoo...(value);
     * vendorUuidBarBhv.<span style="color: #CC4747">queryDelete</span>(vendorUuidBar, cb);
     * </pre>
     * @param cbLambda The callback for condition-bean of VendorUuidBar. (NotNull)
     ...
     * vendorUuidBarBhv.<span style="color: #CC4747">varyingInsert</span>(vendorUuidBar, option);
     * ... = vendorUuidBar.getPK...(); <span style="color: #3F7E5E">// if auto-increment, you can get the value after</span>
     * </pre>
     * @param vendorUuidBar The entity of insert. (NotNull, PrimaryKeyNullAllowed: when auto-increment)
     ...
     *     vendorUuidBarBhv.<span style="color: #CC4747">varyingUpdate</span>(vendorUuidBar, option);
     * } catch (EntityAlreadyUpdatedException e) { <span style="color: #3F7E5E">// if concurrent update</span>
     *     ...
     * }
     * </pre>
     ...
     * vendorUuidBarBhv.<span style="color: #CC4747">varyingQueryUpdate</span>(vendorUuidBar, cb, option);
     * </pre>
