...
public abstract class BsVendorUuidFooBhv extends AbstractBehaviorWritable<VendorUuidFoo, VendorUuidFooCB> {
    ...
    //                                                                             =======
    /** {@inheritDoc} */
    public VendorUuidFooDbm asDBMeta() { return VendorUuidFooDbm.getInstance(); }
    /** {@inheritDoc} */
    public String asTableDbName() { return "vendor_uuid_foo"; }
     ...
     * <span style="color: #0000C0">vendorUuidFooBhv</span>.<span style="color: #CC4747">selectEntity</span>(<span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">cb</span>.query().set...
     * }).<span style="color: #CC4747">alwaysPresent</span>(<span style="color: #553000">vendorUuidFoo</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     * <span style="color: #0000C0">vendorUuidFooBhv</span>.<span style="color: #CC4747">selectEntity</span>(<span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">cb</span>.query().set...
     * }).<span style="color: #CC4747">ifPresent</span>(<span style="color: #553000">vendorUuidFoo</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     */
    public OptionalEntity<VendorUuidFoo> selectEntity(CBCall<VendorUuidFooCB> cbLambda) {
     ...
     *
     * <span style="color: #3F7E5E">// if the data always exists as your business rule</span>
     * <span style="color: #0000C0">vendorUuidFooBhv</span>.<span style="color: #DD4747">selectEntity</span>(cb)}).<span style="color: #CC4747">alwaysPresent</span>(vendorUuidFoo <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #3F7E5E">// called if present, or exception</span>
     *     ... = vendorUuidFoo.get...
     * });
     *
     * <span style="color: #3F7E5E">// if it might be no data, ...</span>
     * <span style="color: #0000C0">vendorUuidFooBhv</span>.<span style="color: #CC4747">selectEntity</span>(cb).<span style="color: #CC4747">ifPresent</span>(vendorUuidFoo <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #3F7E5E">// called if present</span>
     *     ... = vendorUuidFoo.get...
     * }).<span style="color: #994747">orElse</span>(() <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #3F7E5E">// called if not present</span>
     ...
     * @throws SelectEntityConditionNotFoundException When the condition for selecting an entity is not found.
     */
    public OptionalEntity<VendorUuidFoo> selectEntity(VendorUuidFooCB cb) {
        return facadeSelectEntity(cb);
    }

    protected OptionalEntity<VendorUuidFoo> facadeSelectEntity(VendorUuidFooCB cb) {
     ...
     * @throws SelectEntityConditionNotFoundException When the condition for selecting an entity is not found.
     */
    public OptionalEntity<VendorUuidFoo> selectByPK(java.util.UUID fooId) {
        return facadeSelectByPK(fooId);
    }

    protected OptionalEntity<VendorUuidFoo> facadeSelectByPK(java.util.UUID fooId) {
     ...
     * <pre>
     * <span style="color: #0000C0">vendorUuidFooBhv</span>.<span style="color: #CC4747">selectScalar</span>(Date.class).max(<span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     */
    public <RESULT> HpSLSFunction<VendorUuidFooCB, RESULT> selectScalar(Class<RESULT> resultType) {
     ...
     * <span style="color: #0000C0">vendorUuidFooBhv</span>.<span style="color: #CC4747">queryUpdate</span>(vendorUuidFoo, <span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     * vendorUuidFoo.setFoo...(value);
     * vendorUuidFoo.setBar...(value);
     * <span style="color: #0000C0">vendorUuidFooBhv</span>.<span style="color: #CC4747">varyingInsert</span>(vendorUuidFoo, <span style="color: #553000">op</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     * <span style="color: #0000C0">vendorUuidFooBhv</span>.<span style="color: #CC4747">varyingUpdate</span>(vendorUuidFoo, <span style="color: #553000">op</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     * <span style="color: #3F7E5E">// (auto-increment for version number is valid though non-exclusive control)</span>
     * <span style="color: #3F7E5E">//vendorUuidFoo.setVersionNo(value);</span>
     * <span style="color: #0000C0">vendorUuidFooBhv</span>.<span style="color: #CC4747">varyingQueryUpdate</span>(vendorUuidFoo, <span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">cb</span>.query().setFoo...
     ...
     * VendorUuidFooCB cb = <span style="color: #70226C">new</span> VendorUuidFooCB();
     * cb.query().setFoo...(value);
     * <span style="color: #0000C0">vendorUuidFooBhv</span>.<span style="color: #CC4747">varyingQueryUpdate</span>(vendorUuidFoo, cb, <span style="color: #553000">op</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">op</span>.self(<span style="color: #553000">colCB</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *         <span style="color: #553000">colCB</span>.specify().<span style="color: #CC4747">columnFooCount()</span>;
     *     }).plus(1); <span style="color: #3F7E5E">// FOO_COUNT = FOO_COUNT + 1</span>
     * });
     ...
     */
    public OutsideSqlAllFacadeExecutor<VendorUuidFooBhv> outsideSql() {
        return doOutsideSql();
    }
