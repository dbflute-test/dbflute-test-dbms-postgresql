...
public abstract class BsWhiteCompoundPkWrongOrderBhv extends AbstractBehaviorWritable<WhiteCompoundPkWrongOrder, WhiteCompoundPkWrongOrderCB> {
     ...
     * @throws SelectEntityConditionNotFoundException When the condition for selecting an entity is not found.
     */
    public OptionalEntity<WhiteCompoundPkWrongOrder> selectByPK(Integer firstId, Integer thirdId, Integer secondId) {
        return facadeSelectByPK(firstId, thirdId, secondId);
    }

    protected OptionalEntity<WhiteCompoundPkWrongOrder> facadeSelectByPK(Integer firstId, Integer thirdId, Integer secondId) {
        return doSelectOptionalByPK(firstId, thirdId, secondId, typeOfSelectedEntity());
    }
