...
public abstract class BsWhiteNotPkBhv extends AbstractBehaviorReadable<WhiteNotPk, WhiteNotPkCB> {
    ...
    //                                                                             =======
    /** {@inheritDoc} */
    public WhiteNotPkDbm asDBMeta() { return WhiteNotPkDbm.getInstance(); }
    /** {@inheritDoc} */
    public String asTableDbName() { return "white_not_pk"; }
     ...
     * <pre>
     * <span style="color: #70226C">int</span> count = <span style="color: #0000C0">whiteNotPkBhv</span>.<span style="color: #CC4747">selectCount</span>(<span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     * SpecifyColumn is ignored but you can use it only to remove text type column for union's distinct.
     * <pre>
     * WhiteNotPkCB cb = <span style="color: #70226C">new</span> WhiteNotPkCB();
     * cb.query().setFoo...(value);
     * <span style="color: #70226C">int</span> count = <span style="color: #0000C0">whiteNotPkBhv</span>.<span style="color: #CC4747">selectCount</span>(cb);
     * </pre>
     ...
     * <span style="color: #0000C0">whiteNotPkBhv</span>.<span style="color: #CC4747">selectEntity</span>(<span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">cb</span>.query().set...
     * }).<span style="color: #CC4747">alwaysPresent</span>(<span style="color: #553000">whiteNotPk</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     * <span style="color: #0000C0">whiteNotPkBhv</span>.<span style="color: #CC4747">selectEntity</span>(<span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">cb</span>.query().set...
     * }).<span style="color: #CC4747">ifPresent</span>(<span style="color: #553000">whiteNotPk</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     */
    public OptionalEntity<WhiteNotPk> selectEntity(CBCall<WhiteNotPkCB> cbLambda) {
     ...
     *
     * <span style="color: #3F7E5E">// if the data always exists as your business rule</span>
     * <span style="color: #0000C0">whiteNotPkBhv</span>.<span style="color: #DD4747">selectEntity</span>(cb)}).<span style="color: #CC4747">alwaysPresent</span>(whiteNotPk <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #3F7E5E">// called if present, or exception</span>
     *     ... = whiteNotPk.get...
     * });
     *
     * <span style="color: #3F7E5E">// if it might be no data, ...</span>
     * <span style="color: #0000C0">whiteNotPkBhv</span>.<span style="color: #CC4747">selectEntity</span>(cb).<span style="color: #CC4747">ifPresent</span>(whiteNotPk <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #3F7E5E">// called if present</span>
     *     ... = whiteNotPk.get...
     * }).<span style="color: #994747">orElse</span>(() <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #3F7E5E">// called if not present</span>
     ...
     * @throws SelectEntityConditionNotFoundException When the condition for selecting an entity is not found.
     */
    public OptionalEntity<WhiteNotPk> selectEntity(WhiteNotPkCB cb) {
        return facadeSelectEntity(cb);
    }

    protected OptionalEntity<WhiteNotPk> facadeSelectEntity(WhiteNotPkCB cb) {
     ...
     * ... = <span style="color: #553000">whiteNotPk</span>.get...(); <span style="color: #3F7E5E">// the entity always be not null</span>
     * </pre>
     * @param cbLambda The callback for condition-bean of WhiteNotPk. (NotNull)
     ...
     * WhiteNotPkCB cb = <span style="color: #70226C">new</span> WhiteNotPkCB();
     * cb.query().set...;
     * WhiteNotPk whiteNotPk = <span style="color: #0000C0">whiteNotPkBhv</span>.<span style="color: #CC4747">selectEntityWithDeletedCheck</span>(cb);
     ...
     * <pre>
     * ListResultBean&lt;WhiteNotPk&gt; <span style="color: #553000">whiteNotPkList</span> = <span style="color: #0000C0">whiteNotPkBhv</span>.<span style="color: #CC4747">selectList</span>(<span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">cb</span>.query().set...;
     *     <span style="color: #553000">cb</span>.query().addOrderBy...;
     * });
     * <span style="color: #70226C">for</span> (WhiteNotPk <span style="color: #553000">whiteNotPk</span> : <span style="color: #553000">whiteNotPkList</span>) {
     *     ... = <span style="color: #553000">whiteNotPk</span>.get...;
     * }
     * </pre>
     * @param cbLambda The callback for condition-bean of WhiteNotPk. (NotNull)
     ...
     * cb.query().set...;
     * cb.query().addOrderBy...;
     * ListResultBean&lt;WhiteNotPk&gt; <span style="color: #553000">whiteNotPkList</span> = <span style="color: #0000C0">whiteNotPkBhv</span>.<span style="color: #CC4747">selectList</span>(cb);
     * <span style="color: #70226C">for</span> (WhiteNotPk whiteNotPk : <span style="color: #553000">whiteNotPkList</span>) {
     *     ... = whiteNotPk.get...;
     * }
     * </pre>
     * @param cb The condition-bean of WhiteNotPk. (NotNull)
     ...
     * ...
     * <span style="color: #70226C">for</span> (WhiteNotPk whiteNotPk : <span style="color: #553000">page</span>) {
     *     ... = whiteNotPk.get...;
     * }
     * </pre>
     * @param cbLambda The callback for condition-bean of WhiteNotPk. (NotNull)
     ...
     * PagingResultBean&lt;WhiteNotPk&gt; <span style="color: #553000">page</span> = <span style="color: #0000C0">whiteNotPkBhv</span>.<span style="color: #CC4747">selectPage</span>(cb);
     * <span style="color: #70226C">int</span> allRecordCount = <span style="color: #553000">page</span>.getAllRecordCount();
     * <span style="color: #70226C">int</span> allPageCount = <span style="color: #553000">page</span>.getAllPageCount();
     * <span style="color: #70226C">boolean</span> isExistPrePage = <span style="color: #553000">page</span>.isExistPrePage();
     * <span style="color: #70226C">boolean</span> isExistNextPage = <span style="color: #553000">page</span>.isExistNextPage();
     ...
     * <pre>
     * <span style="color: #0000C0">whiteNotPkBhv</span>.<span style="color: #CC4747">selectCursor</span>(<span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">cb</span>.query().set...
     ...
     * WhiteNotPkCB cb = <span style="color: #70226C">new</span> WhiteNotPkCB();
     * cb.query().set...
     * <span style="color: #0000C0">whiteNotPkBhv</span>.<span style="color: #CC4747">selectCursor</span>(cb, <span style="color: #553000">member</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     ... = <span style="color: #553000">member</span>.getMemberName();
     * });
     * </pre>
     * @param cb The condition-bean of WhiteNotPk. (NotNull)
     ...
     * <pre>
     * <span style="color: #0000C0">whiteNotPkBhv</span>.<span style="color: #CC4747">selectScalar</span>(Date.class).max(<span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     */
    public <RESULT> HpSLSFunction<WhiteNotPkCB, RESULT> selectScalar(Class<RESULT> resultType) {
     ...
     * <span style="color: #0000C0">whiteNotPkBhv</span>.<span style="color: #CC4747">insert</span>(whiteNotPk);
     * </pre>
     ...
     */
    public OutsideSqlAllFacadeExecutor<WhiteNotPkBhv> outsideSql() {
        return doOutsideSql();
    }
