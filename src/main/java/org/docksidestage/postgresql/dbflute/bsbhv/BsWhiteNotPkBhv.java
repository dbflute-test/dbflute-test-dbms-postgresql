...
public abstract class BsWhiteNotPkBhv extends AbstractBehaviorReadable<WhiteNotPk, WhiteNotPkCB> {
     ...
     * int count = <span style="color: #0000C0">whiteNotPkBhv</span>.<span style="color: #CC4747">selectCount</span>(cb);
     * </pre>
     ...
     * for (WhiteNotPk whiteNotPk : <span style="color: #553000">whiteNotPkList</span>) {
     *     ... = whiteNotPk.get...();
     * }
     * </pre>
     * @param cb The condition-bean of WhiteNotPk. (NotNull)
     ...
     * ...
     * for (WhiteNotPk whiteNotPk : <span style="color: #553000">page</span>) {
     *     ... = whiteNotPk.get...();
     * }
     * </pre>
     * @param cbLambda The callback for condition-bean of WhiteNotPk. (NotNull)
     ...
     * WhiteNotPkCB cb = new WhiteNotPkCB();
     * cb.query().set...
     * <span style="color: #0000C0">whiteNotPkBhv</span>.<span style="color: #CC4747">selectCursor</span>(cb, new EntityRowHandler&lt;WhiteNotPk&gt;() {
