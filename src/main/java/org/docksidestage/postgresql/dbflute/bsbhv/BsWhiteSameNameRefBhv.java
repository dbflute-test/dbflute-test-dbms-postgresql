...
public abstract class BsWhiteSameNameRefBhv extends AbstractBehaviorWritable<WhiteSameNameRef, WhiteSameNameRefCB> {
     ...
     * <pre>
     * int count = <span style="color: #0000C0">whiteSameNameRefBhv</span>.<span style="color: #CC4747">selectCount</span>(<span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     * int count = <span style="color: #0000C0">whiteSameNameRefBhv</span>.<span style="color: #CC4747">selectCount</span>(cb);
     * </pre>
     ...
     * <pre>
     * WhiteSameNameRef whiteSameNameRef = <span style="color: #0000C0">whiteSameNameRefBhv</span>.<span style="color: #CC4747">selectEntity</span>(<span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">cb</span>.query().set...
     * });
     ...
     */
    public WhiteSameNameRef selectEntity(CBCall<WhiteSameNameRefCB> cbLambda) {
     ...
     * WhiteSameNameRefCB cb = new WhiteSameNameRefCB();
     * cb.query().setFoo...(value);
     * WhiteSameNameRef whiteSameNameRef = <span style="color: #0000C0">whiteSameNameRefBhv</span>.<span style="color: #DD4747">selectEntity</span>(cb);
     * if (whiteSameNameRef != null) { <span style="color: #3F7E5E">// null check</span>
     *     ... = whiteSameNameRef.get...();
     * } else {
     *     ...
     ...
     * @throws SelectEntityConditionNotFoundException When the condition for selecting an entity is not found.
     */
    public WhiteSameNameRef selectByPK(Integer sameNameRefId) {
        return facadeSelectByPK(sameNameRefId);
    }

    protected WhiteSameNameRef facadeSelectByPK(Integer sameNameRefId) {
     ...
     * });
     * for (WhiteSameNameRef <span style="color: #553000">whiteSameNameRef</span> : <span style="color: #553000">whiteSameNameRefList</span>) {
     ...
     * for (WhiteSameNameRef whiteSameNameRef : <span style="color: #553000">whiteSameNameRefList</span>) {
     *     ... = whiteSameNameRef.get...();
     * }
     * </pre>
     * @param cb The condition-bean of WhiteSameNameRef. (NotNull)
     ...
     * ...
     * for (WhiteSameNameRef whiteSameNameRef : <span style="color: #553000">page</span>) {
     *     ... = whiteSameNameRef.get...();
     * }
     * </pre>
     * @param cbLambda The callback for condition-bean of WhiteSameNameRef. (NotNull)
     ...
     * WhiteSameNameRefCB cb = new WhiteSameNameRefCB();
     * cb.query().set...
     * <span style="color: #0000C0">whiteSameNameRefBhv</span>.<span style="color: #CC4747">selectCursor</span>(cb, new EntityRowHandler&lt;WhiteSameNameRef&gt;() {
