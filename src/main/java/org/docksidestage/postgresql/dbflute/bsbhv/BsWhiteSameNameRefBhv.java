...
public abstract class BsWhiteSameNameRefBhv extends AbstractBehaviorWritable<WhiteSameNameRef, WhiteSameNameRefCB> {
    ...
    public int queryUpdate(WhiteSameNameRef whiteSameNameRef, CBCall<WhiteSameNameRefCB> cbLambda) {
        return doQueryUpdate(whiteSameNameRef, handleCBCall(cbLambda), null);
    }
     ...
     * @exception EntityAlreadyExistsException When the entity already exists. (unique constraint violation)
     */
    public void varyingInsert(WhiteSameNameRef whiteSameNameRef, WOptionCall<WhiteSameNameRefCB, InsertOption<WhiteSameNameRefCB>> opLambda) {
        doInsert(whiteSameNameRef, handleInsertOpCall(opLambda));
    }
     ...
     * @exception EntityAlreadyExistsException When the entity already exists. (unique constraint violation)
     */
    public void varyingUpdate(WhiteSameNameRef whiteSameNameRef, WOptionCall<WhiteSameNameRefCB, UpdateOption<WhiteSameNameRefCB>> opLambda) {
        doUpdate(whiteSameNameRef, handleUpdateOpCall(opLambda));
    }
     ...
     * @exception EntityAlreadyExistsException When the entity already exists. (unique constraint violation)
     */
    public void varyingInsertOrUpdate(WhiteSameNameRef whiteSameNameRef, WOptionCall<WhiteSameNameRefCB, InsertOption<WhiteSameNameRefCB>> insertOpLambda, WOptionCall<WhiteSameNameRefCB, UpdateOption<WhiteSameNameRefCB>> updateOpLambda) {
        doInsertOrUpdate(whiteSameNameRef, handleInsertOpCall(insertOpLambda), handleUpdateOpCall(updateOpLambda));
    }
     ...
     * @exception EntityDuplicatedException When the entity has been duplicated.
     */
    public void varyingDelete(WhiteSameNameRef whiteSameNameRef, WOptionCall<WhiteSameNameRefCB, DeleteOption<WhiteSameNameRefCB>> opLambda) {
        doDelete(whiteSameNameRef, handleDeleteOpCall(opLambda));
    }
     ...
     * @return The array of updated count. (NotNull, EmptyAllowed)
     */
    public int[] varyingBatchInsert(List<WhiteSameNameRef> whiteSameNameRefList, WOptionCall<WhiteSameNameRefCB, InsertOption<WhiteSameNameRefCB>> opLambda) {
        return doBatchInsert(whiteSameNameRefList, handleInsertOpCall(opLambda));
    }
     ...
     * @return The array of updated count. (NotNull, EmptyAllowed)
     */
    public int[] varyingBatchUpdate(List<WhiteSameNameRef> whiteSameNameRefList, WOptionCall<WhiteSameNameRefCB, UpdateOption<WhiteSameNameRefCB>> opLambda) {
        return doBatchUpdate(whiteSameNameRefList, handleUpdateOpCall(opLambda));
    }
     ...
     * @return The array of deleted count. (NotNull, EmptyAllowed)
     */
    public int[] varyingBatchDelete(List<WhiteSameNameRef> whiteSameNameRefList, WOptionCall<WhiteSameNameRefCB, DeleteOption<WhiteSameNameRefCB>> opLambda) {
        return doBatchDelete(whiteSameNameRefList, handleDeleteOpCall(opLambda));
    }
     ...
     * @return The inserted count.
     */
    public int varyingQueryInsert(QueryInsertSetupper<WhiteSameNameRef, WhiteSameNameRefCB> manyArgLambda, WOptionCall<WhiteSameNameRefCB, InsertOption<WhiteSameNameRefCB>> opLambda) {
     ...
     */
    public int varyingQueryUpdate(WhiteSameNameRef whiteSameNameRef, CBCall<WhiteSameNameRefCB> cbLambda, WOptionCall<WhiteSameNameRefCB, UpdateOption<WhiteSameNameRefCB>> opLambda) {
        return doQueryUpdate(whiteSameNameRef, handleCBCall(cbLambda), handleUpdateOpCall(opLambda));
    }
     ...
     * @exception NonQueryUpdateNotAllowedException When the query has no condition (if not allowed).
     */
    public int varyingQueryUpdate(WhiteSameNameRef whiteSameNameRef, WhiteSameNameRefCB cb, WOptionCall<WhiteSameNameRefCB, UpdateOption<WhiteSameNameRefCB>> opLambda) {
        return doQueryUpdate(whiteSameNameRef, cb, handleUpdateOpCall(opLambda));
    }
     ...
     */
    public int varyingQueryDelete(CBCall<WhiteSameNameRefCB> cbLambda, WOptionCall<WhiteSameNameRefCB, DeleteOption<WhiteSameNameRefCB>> opLambda) {
     ...
     * @exception NonQueryDeleteNotAllowedException When the query has no condition (if not allowed).
     */
    public int varyingQueryDelete(WhiteSameNameRefCB cb, WOptionCall<WhiteSameNameRefCB, DeleteOption<WhiteSameNameRefCB>> opLambda) {
