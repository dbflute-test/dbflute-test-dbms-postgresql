...
/**
 * The base class for procedure parameter-bean of FnNonameArgAddingTimestamp. <br>
 * This is related to "<span style="color: #AD4747">fn_noname_arg_adding_timestamp</span>".
 * @author DBFlute(AutoGenerator)
 */
public class BsFnNonameArgAddingTimestampPmb implements ProcedurePmb, FetchBean {
    ...
    //                                                                           Attribute
    //                                                                           =========
    /** The parameter of returnValue: {timestamp as Return}. */
    protected java.time.LocalDateTime _returnValue;

    /** The parameter of $1: {timestamptz as In}. */
    protected java.time.LocalDateTime _$1;
    ...
    //                                                                         ===========
    /**
     * Constructor for the procedure parameter-bean of FnNonameArgAddingTimestamp. <br>
     * This is related to "<span style="color: #AD4747">fn_noname_arg_adding_timestamp</span>".
     */
    public BsFnNonameArgAddingTimestampPmb() {
    }
     ...
     * {@inheritDoc}
     */
    public String getProcedureName() { return "fn_noname_arg_adding_timestamp"; }
    ...
    //                                                                            ========
    /**
     * [get] returnValue: {timestamp as Return} <br>
     * @return The value of returnValue. (NullAllowed, NotEmptyString(when String): if empty string, returns null)
     */
    public java.time.LocalDateTime getReturnValue() {
        return _returnValue;
    }

    /**
     * [set] returnValue: {timestamp as Return} <br>
     * @param returnValue The value of returnValue. (NullAllowed)
     */
    public void setReturnValue(java.time.LocalDateTime returnValue) {
        _returnValue = returnValue;
    }

    /**
     * [get] $1: {timestamptz as In} <br>
     * @return The value of $1. (NullAllowed, NotEmptyString(when String): if empty string, returns null)
     */
    public java.time.LocalDateTime get$1() {
        return _$1;
    }

    /**
     * [set] $1: {timestamptz as In} <br>
     * @param $1 The value of $1. (NullAllowed)
     */
    public void set$1(java.time.LocalDateTime $1) {
        _$1 = $1;
    }
