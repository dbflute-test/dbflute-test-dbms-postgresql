...
/**
 * The base class for procedure parameter-bean of FnReturnResultSetWith. <br>
 * This is related to "<span style="color: #AD4747">fn_return_result_set_with</span>".
 * @author DBFlute(AutoGenerator)
 */
public class BsFnReturnResultSetWithPmb implements ProcedurePmb, FetchBean {
    ...
    protected List<FnReturnResultSetWithReturnValue> _returnValue;
    ...
    //                                                                         ===========
    /**
     * Constructor for the procedure parameter-bean of FnReturnResultSetWith. <br>
     * This is related to "<span style="color: #AD4747">fn_return_result_set_with</span>".
     */
    public BsFnReturnResultSetWithPmb() {
    }
     ...
     * {@inheritDoc}
     */
    public String getProcedureName() { return "fn_return_result_set_with"; }
     ...
     */
    public List<FnReturnResultSetWithReturnValue> getReturnValue() {
        return _returnValue;
    }
     ...
     */
    public void setReturnValue(List<FnReturnResultSetWithReturnValue> returnValue) {
