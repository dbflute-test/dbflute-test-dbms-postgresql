...
/**
 * The entity of nested_summary_product as VIEW.
 * @author DBFlute(AutoGenerator)
 */
public abstract class BsNestedSummaryProduct extends AbstractEntity implements DomainEntity {
    ...
    protected boolean doEquals(Object obj) {
        if (obj instanceof BsNestedSummaryProduct) {
            BsNestedSummaryProduct other = (BsNestedSummaryProduct)obj;
    ...
    @Override
    public NestedSummaryProduct clone() {
        return (NestedSummaryProduct)super.clone();
    }
