...
/**
 * The entity of wrapped_summary_product as VIEW.
 * @author DBFlute(AutoGenerator)
 */
public abstract class BsWrappedSummaryProduct extends AbstractEntity implements DomainEntity {
    ...
    protected boolean doEquals(Object obj) {
        if (obj instanceof BsWrappedSummaryProduct) {
            BsWrappedSummaryProduct other = (BsWrappedSummaryProduct)obj;
    ...
    @Override
    public WrappedSummaryProduct clone() {
        return (WrappedSummaryProduct)super.clone();
    }
