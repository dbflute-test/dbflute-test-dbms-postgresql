...
/**
 * The entity of FnResultSetParameterMoreCurMember. <br>
 * <pre>
 * [primary-key]
 *     
 *
 ...
 */
public abstract class BsFnResultSetParameterMoreCurMember extends AbstractEntity implements CustomizeEntity {
    ...
    public DBMeta asDBMeta() {
        return org.docksidestage.postgresql.dbflute.bsentity.customize.dbmeta.FnResultSetParameterMoreCurMemberDbm.getInstance();
    }

    /** {@inheritDoc} */
    public String asTableDbName() {
        return "FnResultSetParameterMoreCurMember";
    }
    ...
    protected boolean doEquals(Object obj) {
        if (obj instanceof BsFnResultSetParameterMoreCurMember) {
            BsFnResultSetParameterMoreCurMember other = (BsFnResultSetParameterMoreCurMember)obj;
    ...
    @Override
    public FnResultSetParameterMoreCurMember clone() {
        return (FnResultSetParameterMoreCurMember)super.clone();
    }
