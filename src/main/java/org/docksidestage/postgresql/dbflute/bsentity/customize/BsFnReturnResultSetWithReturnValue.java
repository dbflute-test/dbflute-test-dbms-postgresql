...
public abstract class BsFnReturnResultSetWithReturnValue extends AbstractEntity implements CustomizeEntity {
    ...
    public DBMeta asDBMeta() {
        return org.docksidestage.postgresql.dbflute.bsentity.customize.dbmeta.FnReturnResultSetWithReturnValueDbm.getInstance();
    }

    /** {@inheritDoc} */
    public String asTableDbName() {
        return "FnReturnResultSetWithReturnValue";
    }
    ...
    protected boolean doEquals(Object obj) {
        if (obj instanceof BsFnReturnResultSetWithReturnValue) {
            BsFnReturnResultSetWithReturnValue other = (BsFnReturnResultSetWithReturnValue)obj;
    ...
    @Override
    public FnReturnResultSetWithReturnValue clone() {
        return (FnReturnResultSetWithReturnValue)super.clone();
    }
