...
public class SpReturnResultSetReturnValueDbm extends AbstractDBMeta {
    ...
    protected final Map<String, PropertyGateway> _epgMap = newHashMap();
    {
        ...
        setupEpg(_epgMap, et -> ((SpReturnResultSetReturnValue)et).getBirthdate(), (et, vl) -> ((SpReturnResultSetReturnValue)et).setBirthdate((java.util.Date)vl), "birthdate");
        setupEpg(_epgMap, et -> ((SpReturnResultSetReturnValue)et).getFormalizedDatetime(), (et, vl) -> ((SpReturnResultSetReturnValue)et).setFormalizedDatetime((java.sql.Timestamp)vl), "formalizedDatetime");
