...
public class MemberAddressDbm extends AbstractDBMeta {
    ...
    //                                                                         Column Info
    //                                                                         ===========
    protected final ColumnInfo _columnMemberAddressId = cci("member_address_id", "member_address_id", null, "会員住所ID", Integer.class, "memberAddressId", null, true, true, true, "serial", 10, 0, null, "nextval('member_address_member_address_id_seq'::regclass)", false, null, "会員住所を識別するID。\n履歴分も含むテーブルなので、これ自体はFKではない。", null, null, null, false);
    ...
    protected final ColumnInfo _columnValidBeginDate = cci("valid_begin_date", "valid_begin_date", null, "有効開始日", java.time.LocalDate.class, "validBeginDate", null, false, false, true, "date", 13, 0, null, null, false, null, "一つの有効期間の開始を示す日付。\n前の有効終了日の次の日の値が格納される。", null, null, null, false);
    protected final ColumnInfo _columnValidEndDate = cci("valid_end_date", "valid_end_date", null, "有効終了日", java.time.LocalDate.class, "validEndDate", null, false, false, true, "date", 13, 0, null, null, false, null, "有効期間の終了日。\n次の有効開始日の一日前の値が格納される。\nただし、次の有効期間がない場合は 9999/12/31 となる。", null, null, null, false);
    ...
    protected final ColumnInfo _columnRegionId = cci("region_id", "region_id", null, "地域ID", Integer.class, "regionId", null, false, false, true, "int4", 10, 0, null, null, false, null, "地域を参照するID。\nここでは特に住所の内容と連動しているわけではない。\n（業務的one-to-oneの親テーブルの表現したかっ...）", "region", null, CDef.DefMeta.Region, false);
