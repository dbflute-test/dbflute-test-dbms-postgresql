...
public class PurchaseDbm extends AbstractDBMeta {
    ...
    //                                                                         Column Info
    //                                                                         ===========
    protected final ColumnInfo _columnPurchaseId = cci("purchase_id", "purchase_id", null, null, Long.class, "purchaseId", null, true, true, true, "bigserial", 19, 0, null, "nextval('purchase_purchase_id_seq'::regclass)", false, null, null, null, "purchasePaymentList", null, false);
    protected final ColumnInfo _columnMemberId = cci("member_id", "member_id", null, "会員ID", Integer.class, "memberId", null, false, false, true, "int4", 10, 0, null, null, false, null, "会員を参照するID。\n購入を識別する自然キー（複合ユニーク制約）の筆頭要素。", "member", null, null, false);
    protected final ColumnInfo _columnProductId = cci("product_id", "product_id", null, "商品ID", Integer.class, "productId", null, false, false, true, "int4", 10, 0, null, null, false, null, "商品を参照するID。", "product", null, null, false);
    protected final ColumnInfo _columnPurchaseDatetime = cci("purchase_datetime", "purchase_datetime", null, "購入日時", java.time.LocalDateTime.class, "purchaseDatetime", null, false, false, true, "timestamp", 26, 3, null, null, false, null, "購入した瞬間の日時。", null, null, null, false);
    protected final ColumnInfo _columnPurchaseCount = cci("purchase_count", "purchase_count", null, "購入数量", Integer.class, "purchaseCount", null, false, false, true, "int4", 10, 0, null, null, false, null, "購入した商品の（一回の購入における）数量。", null, null, null, false);
    protected final ColumnInfo _columnPurchasePrice = cci("purchase_price", "purchase_price", null, "購入価格", Integer.class, "purchasePrice", null, false, false, true, "int4", 10, 0, null, null, false, null, "購入によって実際に会員が支払った（支払う予定の）価格。\n基本は商品の定価に購入数量を掛けたものになるが、\nポイント利用や割引があったりと必ずしもそうはならない。", null, null, null, false);
    protected final ColumnInfo _columnPaymentCompleteFlg = cci("payment_complete_flg", "payment_complete_flg", null, "支払完了フラグ", Integer.class, "paymentCompleteFlg", null, false, false, true, "int4", 10, 0, null, null, false, null, "この購入に関しての支払いが完了しているか否か。", null, null, CDef.DefMeta.Flg, false);
