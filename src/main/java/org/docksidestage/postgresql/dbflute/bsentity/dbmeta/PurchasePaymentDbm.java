...
public class PurchasePaymentDbm extends AbstractDBMeta {
    ...
    protected final ColumnInfo _columnPaymentDatetime = cci("payment_datetime", "payment_datetime", null, "支払日時", java.time.LocalDateTime.class, "paymentDatetime", null, false, false, true, "timestamp", 26, 3, null, false, null, "支払ったときの日時", null, null, null);
    ...
    protected final ColumnInfo _columnRegisterDatetime = cci("register_datetime", "register_datetime", null, null, java.time.LocalDateTime.class, "registerDatetime", null, false, false, true, "timestamp", 26, 3, null, false, null, null, null, null, null);
    ...
    protected final ColumnInfo _columnUpdateDatetime = cci("update_datetime", "update_datetime", null, null, java.time.LocalDateTime.class, "updateDatetime", null, false, false, true, "timestamp", 26, 3, null, false, null, null, null, null, null);
