...
public class BsNextSchemaProductCB extends AbstractConditionBean {
    ...
    public static class HpSpecification extends HpAbstractSpecification<NextSchemaProductCQ> {
         ...
         * <pre>
         * cb.specify().<span style="color: #CC4747">derived${relationMethodIdentityName}()</span>.<span style="color: #CC4747">max</span>(nameCB <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
         *     nameCB.specify().<span style="color: #CC4747">column...</span> <span style="color: #3F7E5E">// derived column by function</span>
         *     nameCB.query().set... <span style="color: #3F7E5E">// referrer condition</span>
         * }, WhiteSameName.<span style="color: #CC4747">ALIAS_foo...</span>);
         * </pre>
        ...
        public HpSDRFunction<WhiteSameNameCB, NextSchemaProductCQ> derivedWhiteSameName() {
            ...
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<WhiteSameNameCB> sq, NextSchemaProductCQ cq, String al, DerivedReferrerOption op)
