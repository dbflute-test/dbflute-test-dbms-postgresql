...
public class BsNextschemaWhiteSameNameCB extends AbstractConditionBean {
     ...
     * <pre>
     * cb.query().<span style="color: #CC4747">union</span>(new UnionQuery&lt;NextschemaWhiteSameNameCB&gt;() {
     ...
     * because it inherits calls before. (Don't call SetupSelect after here)
     * <pre>
     * cb.query().<span style="color: #CC4747">unionAll</span>(new UnionQuery&lt;NextschemaWhiteSameNameCB&gt;() {
     *     public void query(NextschemaWhiteSameNameCB unionCB) {
     *         unionCB.query().setXxx...
     *     }
     * });
    ...
    public static class HpSpecification extends HpAbstractSpecification<NextschemaWhiteSameNameCQ> {
        ...
        public HpSDRFunction<NextschemaWhiteSameNameRefCB, NextschemaWhiteSameNameCQ> derivedWhiteSameNameRefList() {
            ...
            return cHSDRF(_baseCB, _qyCall.qy(), new HpSDRSetupper<NextschemaWhiteSameNameRefCB, NextschemaWhiteSameNameCQ>() {
        ...
        public HpSDRFunction<NextschemaWhiteSameNameCB, NextschemaWhiteSameNameCQ> myselfDerived() {
            ...
            return cHSDRF(_baseCB, _qyCall.qy(), new HpSDRSetupper<NextschemaWhiteSameNameCB, NextschemaWhiteSameNameCQ>() {
