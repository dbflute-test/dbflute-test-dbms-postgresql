...
public class BsNextschemaWhiteSameNameCB extends AbstractConditionBean {
     ...
     */
    public void union(UnionQuery<NextschemaWhiteSameNameCB> unionCBLambda) {
     ...
     */
    public void unionAll(UnionQuery<NextschemaWhiteSameNameCB> unionCBLambda) {
        final NextschemaWhiteSameNameCB cb = new NextschemaWhiteSameNameCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
    ...
    public static class HpSpecification extends HpAbstractSpecification<NextschemaWhiteSameNameCQ> {
         ...
         * }, NextschemaWhiteSameNameRef.<span style="color: #CC4747">ALIAS_foo...</span>);
         * </pre>
         * @return The object to set up a function for referrer table. (NotNull)
         */
        public HpSDRFunction<NextschemaWhiteSameNameRefCB, NextschemaWhiteSameNameCQ> derivedWhiteSameNameRef() {
            assertDerived("whiteSameNameRefList"); if (xhasSyncQyCall()) { xsyncQyCall().qy(); } // for sync (for example, this in ColumnQuery)
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<NextschemaWhiteSameNameRefCB> sq, NextschemaWhiteSameNameCQ cq, String al, DerivedReferrerOption op)
        ...
        public HpSDRFunction<NextschemaWhiteSameNameCB, NextschemaWhiteSameNameCQ> myselfDerived() {
            ...
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<NextschemaWhiteSameNameCB> sq, NextschemaWhiteSameNameCQ cq, String al, DerivedReferrerOption op)
     ...
     * cb.<span style="color: #CC4747">columnQuery</span>(new SpecifyQuery&lt;NextschemaWhiteSameNameCB&gt;() {
     ...
     * cb.<span style="color: #CC4747">orScopeQuery</span>(new OrQuery&lt;NextschemaWhiteSameNameCB&gt;() {
     ...
     */
    public void orScopeQuery(OrQuery<NextschemaWhiteSameNameCB> orCBLambda) {
        xorSQ((NextschemaWhiteSameNameCB)this, orCBLambda);
    }
     ...
     *     public void query(NextschemaWhiteSameNameCB orCB) {
     *         orCB.query().setFOO_Equal...
     *         orCB.<span style="color: #CC4747">orScopeQueryAndPart</span>(new AndQuery&lt;NextschemaWhiteSameNameCB&gt;() {
     ...
     */
    public void orScopeQueryAndPart(AndQuery<NextschemaWhiteSameNameCB> andCBLambda) {
        xorSQAP((NextschemaWhiteSameNameCB)this, andCBLambda);
    }
