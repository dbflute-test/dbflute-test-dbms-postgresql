...
public class BsNextschemaWhiteSameNameRefCB extends AbstractConditionBean {
     ...
     * <pre>
     * cb.query().<span style="color: #CC4747">union</span>(new UnionQuery&lt;NextschemaWhiteSameNameRefCB&gt;() {
     ...
     * because it inherits calls before. (Don't call SetupSelect after here)
     * <pre>
     * cb.query().<span style="color: #CC4747">unionAll</span>(new UnionQuery&lt;NextschemaWhiteSameNameRefCB&gt;() {
     *     public void query(NextschemaWhiteSameNameRefCB unionCB) {
     *         unionCB.query().setXxx...
     *     }
     * });
    ...
    public HpSpecification specify() {
        ...
        if (_specification == null) { _specification = new HpSpecification(this
            , new HpSpQyCall<NextschemaWhiteSameNameRefCQ>() {
                ...
                public NextschemaWhiteSameNameRefCQ qy() { return xdfgetConditionQuery(); }
            }
    ...
    public static class HpSpecification extends HpAbstractSpecification<NextschemaWhiteSameNameRefCQ> {
        ...
        public HpSDRFunction<NextschemaWhiteSameNameRefCB, NextschemaWhiteSameNameRefCQ> myselfDerived() {
            ...
            return cHSDRF(_baseCB, _qyCall.qy(), new HpSDRSetupper<NextschemaWhiteSameNameRefCB, NextschemaWhiteSameNameRefCQ>() {
    ...
    public HpColQyOperand<NextschemaWhiteSameNameRefCB> columnQuery(final SpecifyQuery<NextschemaWhiteSameNameRefCB> colCBLambda) {
        return xcreateColQyOperand(new HpColQyHandler<NextschemaWhiteSameNameRefCB>() {
            public ColumnCalculator handle(SpecifyQuery<NextschemaWhiteSameNameRefCB> rightSp, String operand) {
