...
public class BsVendorInheritInuCB extends AbstractConditionBean {
     ...
     */
    public void union(UnionQuery<VendorInheritInuCB> unionCBLambda) {
     ...
     */
    public void unionAll(UnionQuery<VendorInheritInuCB> unionCBLambda) {
        final VendorInheritInuCB cb = new VendorInheritInuCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
    ...
    public static class HpSpecification extends HpAbstractSpecification<VendorInheritInuCQ> {
        ...
        public HpSDRFunction<VendorInheritInuCB, VendorInheritInuCQ> myselfDerived() {
            ...
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<VendorInheritInuCB> sq, VendorInheritInuCQ cq, String al, DerivedReferrerOption op)
     ...
     */
    public void orScopeQuery(OrQuery<VendorInheritInuCB> orCBLambda) {
        xorSQ((VendorInheritInuCB)this, orCBLambda);
    }
     ...
     */
    public void orScopeQueryAndPart(AndQuery<VendorInheritInuCB> andCBLambda) {
        xorSQAP((VendorInheritInuCB)this, andCBLambda);
    }
