...
public class BsVendorInheritNekoCB extends AbstractConditionBean {
     ...
     */
    public void union(UnionQuery<VendorInheritNekoCB> unionCBLambda) {
     ...
     */
    public void unionAll(UnionQuery<VendorInheritNekoCB> unionCBLambda) {
        final VendorInheritNekoCB cb = new VendorInheritNekoCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
    ...
    public static class HpSpecification extends HpAbstractSpecification<VendorInheritNekoCQ> {
        ...
        public HpSDRFunction<VendorInheritNekoCB, VendorInheritNekoCQ> myselfDerived() {
            ...
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<VendorInheritNekoCB> sq, VendorInheritNekoCQ cq, String al, DerivedReferrerOption op)
     ...
     * cb.<span style="color: #CC4747">columnQuery</span>(new SpecifyQuery&lt;VendorInheritNekoCB&gt;() {
     ...
     * cb.<span style="color: #CC4747">orScopeQuery</span>(new OrQuery&lt;VendorInheritNekoCB&gt;() {
     ...
     */
    public void orScopeQuery(OrQuery<VendorInheritNekoCB> orCBLambda) {
        xorSQ((VendorInheritNekoCB)this, orCBLambda);
    }
     ...
     *     public void query(VendorInheritNekoCB orCB) {
     *         orCB.query().setFOO_Equal...
     *         orCB.<span style="color: #CC4747">orScopeQueryAndPart</span>(new AndQuery&lt;VendorInheritNekoCB&gt;() {
     ...
     */
    public void orScopeQueryAndPart(AndQuery<VendorInheritNekoCB> andCBLambda) {
        xorSQAP((VendorInheritNekoCB)this, andCBLambda);
    }
