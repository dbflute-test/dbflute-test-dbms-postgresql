...
public class BsWhiteSameNameRefCB extends AbstractConditionBean {
     ...
     */
    public void union(UnionQuery<WhiteSameNameRefCB> unionCBLambda) {
     ...
     */
    public void unionAll(UnionQuery<WhiteSameNameRefCB> unionCBLambda) {
        final WhiteSameNameRefCB cb = new WhiteSameNameRefCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
    ...
    public static class HpSpecification extends HpAbstractSpecification<WhiteSameNameRefCQ> {
        ...
        public WhiteSameNameCB.HpSpecification specifyWhiteSameName() {
            ...
            if (_whiteSameName == null) {
                _whiteSameName = new WhiteSameNameCB.HpSpecification(_baseCB
        ...
        public HpSDRFunction<WhiteSameNameRefCB, WhiteSameNameRefCQ> myselfDerived() {
            ...
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<WhiteSameNameRefCB> sq, WhiteSameNameRefCQ cq, String al, DerivedReferrerOption op)
