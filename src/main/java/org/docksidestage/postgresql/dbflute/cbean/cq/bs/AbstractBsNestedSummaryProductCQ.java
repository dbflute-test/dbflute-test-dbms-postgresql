...
/**
 * The abstract condition-query of nested_summary_product.
 * @author DBFlute(AutoGenerator)
 */
public abstract class AbstractBsNestedSummaryProductCQ extends AbstractConditionQuery {

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public AbstractBsNestedSummaryProductCQ(ConditionQuery referrerQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
     ...
     */
    public HpSLCFunction<NestedSummaryProductCB> scalar_Equal() {
        return xcreateSLCFunction(CK_EQ, NestedSummaryProductCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<NestedSummaryProductCB> scalar_NotEqual() {
        return xcreateSLCFunction(CK_NES, NestedSummaryProductCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<NestedSummaryProductCB> scalar_GreaterThan() {
        return xcreateSLCFunction(CK_GT, NestedSummaryProductCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<NestedSummaryProductCB> scalar_LessThan() {
        return xcreateSLCFunction(CK_LT, NestedSummaryProductCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<NestedSummaryProductCB> scalar_GreaterEqual() {
        return xcreateSLCFunction(CK_GE, NestedSummaryProductCB.class);
    }
     ...
     * {where FOO &lt;= (select max(BAR) from ...)}
     * <pre>
     * cb.query().<span style="color: #CC4747">scalar_LessEqual()</span>.max(new SubQuery&lt;NestedSummaryProductCB&gt;() {
     *     public void query(NestedSummaryProductCB subCB) {
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<NestedSummaryProductCB> scalar_LessEqual() {
        return xcreateSLCFunction(CK_LE, NestedSummaryProductCB.class);
    }

    @SuppressWarnings("unchecked")
    protected <CB extends ConditionBean> void xscalarCondition(String fn, SubQuery<CB> sq, String rd, HpSLCCustomized<CB> cs, ScalarConditionOption op) {
        assertObjectNotNull("subQuery", sq);
        NestedSummaryProductCB cb = xcreateScalarConditionCB(); sq.query((CB)cb);
        String pp = keepScalarCondition(cb.query()); // for saving query-value
        cs.setPartitionByCBean((CB)xcreateScalarConditionPartitionByCB()); // for using partition-by
        registerScalarCondition(fn, cb.query(), pp, rd, cs, op);
    }
    public abstract String keepScalarCondition(NestedSummaryProductCQ sq);

    protected NestedSummaryProductCB xcreateScalarConditionCB() {
        NestedSummaryProductCB cb = newMyCB(); cb.xsetupForScalarCondition(this); return cb;
    }

    protected NestedSummaryProductCB xcreateScalarConditionPartitionByCB() {
        NestedSummaryProductCB cb = newMyCB(); cb.xsetupForScalarConditionPartitionBy(this); return cb;
    }
    ...
    //                                                                       Very Internal
    //                                                                       =============
    protected NestedSummaryProductCB newMyCB() {
        return new NestedSummaryProductCB();
    }
    // very internal (for suppressing warn about 'Not Use Import')
    protected String xabUDT() { return Date.class.getName(); }
    protected String xabCQ() { return NestedSummaryProductCQ.class.getName(); }
