...
public abstract class AbstractBsNextSchemaProductCQ extends AbstractConditionQuery {
     ...
     * white_same_name by next_schema_product_id, named 'whiteSameNameAsOne'.
     * <pre>
     * cb.query().<span style="color: #DD4747">derivedWhiteSameNameList()</span>.<span style="color: #DD4747">max</span>(nameCB -&gt; {
     *     nameCB.specify().<span style="color: #DD4747">columnFoo...</span> <span style="color: #3F7E5E">// derived column by function</span>
