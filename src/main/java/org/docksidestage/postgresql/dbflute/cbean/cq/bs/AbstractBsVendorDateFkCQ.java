...
public abstract class AbstractBsVendorDateFkCQ extends AbstractConditionQuery {
     ...
     */
    public void setBarId_RangeOf(Integer minNumber, Integer maxNumber, COptionCall<RangeOfOption> opLambda) {
     ...
     */
    public void setBarDate_FromTo(Date fromDatetime, Date toDatetime, COptionCall<FromToOption> opLambda) {
