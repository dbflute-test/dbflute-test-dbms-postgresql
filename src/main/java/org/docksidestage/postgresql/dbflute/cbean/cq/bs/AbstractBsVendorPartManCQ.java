...
public abstract class AbstractBsVendorPartManCQ extends AbstractConditionQuery {
     ...
     */
    public void setPartManId_RangeOf(Integer minNumber, Integer maxNumber, COptionCall<RangeOfOption> opLambda) {
     ...
     */
    public void setPartManName_LikeSearch(String partManName, COptionCall<LikeSearchOption> opLambda) {
     ...
     * @param opLambda The callback for option of like-search. (NotNull)
     */
    public void setPartManName_NotLikeSearch(String partManName, COptionCall<LikeSearchOption> opLambda) {
     ...
     * @param opLambda The callback for option of range-of. (NotNull)
     */
    public void setPartManPoint_RangeOf(Integer minNumber, Integer maxNumber, COptionCall<RangeOfOption> opLambda) {
     ...
     */
    public void setPartManDate_FromTo(Date fromDatetime, Date toDatetime, COptionCall<FromToOption> opLambda) {
