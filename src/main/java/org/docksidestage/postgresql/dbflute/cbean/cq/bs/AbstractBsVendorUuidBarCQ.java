...
public abstract class AbstractBsVendorUuidBarCQ extends AbstractConditionQuery {
     ...
     */
    public void setBarName_LikeSearch(String barName, COptionCall<LikeSearchOption> opLambda) {
     ...
     * @param opLambda The callback for option of like-search. (NotNull)
     */
    public void setBarName_NotLikeSearch(String barName, COptionCall<LikeSearchOption> opLambda) {
