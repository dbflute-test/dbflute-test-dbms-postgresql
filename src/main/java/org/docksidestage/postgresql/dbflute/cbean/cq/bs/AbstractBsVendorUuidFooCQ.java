...
public abstract class AbstractBsVendorUuidFooCQ extends AbstractConditionQuery {
     ...
     */
    public HpSLCFunction<VendorUuidFooCB> scalar_Equal() {
        return xcreateSLCFunction(CK_EQ, VendorUuidFooCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<VendorUuidFooCB> scalar_NotEqual() {
        return xcreateSLCFunction(CK_NES, VendorUuidFooCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<VendorUuidFooCB> scalar_GreaterThan() {
        return xcreateSLCFunction(CK_GT, VendorUuidFooCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<VendorUuidFooCB> scalar_LessThan() {
        return xcreateSLCFunction(CK_LT, VendorUuidFooCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<VendorUuidFooCB> scalar_GreaterEqual() {
        return xcreateSLCFunction(CK_GE, VendorUuidFooCB.class);
    }
     ...
     * {where FOO &lt;= (select max(BAR) from ...)}
     * <pre>
     * cb.query().<span style="color: #CC4747">scalar_LessEqual()</span>.max(new SubQuery&lt;VendorUuidFooCB&gt;() {
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<VendorUuidFooCB> scalar_LessEqual() {
        return xcreateSLCFunction(CK_LE, VendorUuidFooCB.class);
    }
     ...
     */
    public void myselfExists(SubQuery<VendorUuidFooCB> subCBLambda) {
