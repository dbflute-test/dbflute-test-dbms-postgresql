...
public abstract class AbstractBsWhiteNotPkCQ extends AbstractConditionQuery {
     ...
     */
    public void setNotPkId_RangeOf(Long minNumber, Long maxNumber, COptionCall<RangeOfOption> opLambda) {
     ...
     */
    public void setNotPkName_LikeSearch(String notPkName, COptionCall<LikeSearchOption> opLambda) {
     ...
     * @param opLambda The callback for option of like-search. (NotNull)
     */
    public void setNotPkName_NotLikeSearch(String notPkName, COptionCall<LikeSearchOption> opLambda) {
     ...
     * @param opLambda The callback for option of range-of. (NotNull)
     */
    public void setNotPkInteger_RangeOf(Integer minNumber, Integer maxNumber, COptionCall<RangeOfOption> opLambda) {
