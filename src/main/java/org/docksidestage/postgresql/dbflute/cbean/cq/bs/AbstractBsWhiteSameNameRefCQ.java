...
public abstract class AbstractBsWhiteSameNameRefCQ extends AbstractConditionQuery {
     ...
     */
    public void setSameNameRefId_RangeOf(Integer minNumber, Integer maxNumber, COptionCall<RangeOfOption> opLambda) {
     ...
     * @param opLambda The callback for option of range-of. (NotNull)
     */
    public void setNextSameNameId_RangeOf(Long minNumber, Long maxNumber, COptionCall<RangeOfOption> opLambda) {
