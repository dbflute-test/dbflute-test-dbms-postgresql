...
public abstract class AbstractBsWhiteXlsManCQ extends AbstractConditionQuery {
     ...
     */
    public void setTimestampZeroDefaultMillis_FromTo(Date fromDatetime, Date toDatetime, COptionCall<FromToOption> opLambda) {
     ...
     * @param opLambda The callback for option of from-to. (NotNull)
     */
    public void setTimestampZeroPrefixMillis_FromTo(Date fromDatetime, Date toDatetime, COptionCall<FromToOption> opLambda) {
     ...
     * @param opLambda The callback for option of from-to. (NotNull)
     */
    public void setTimestampZeroSuffixMillis_FromTo(Date fromDatetime, Date toDatetime, COptionCall<FromToOption> opLambda) {
