...
import org.docksidestage.postgresql.dbflute.cbean.MemberAddressCB;
...
import org.docksidestage.postgresql.dbflute.exentity.MemberAddress;
...
public class ConditionBeanPlatinumTest extends UnitContainerTestCase {
    ...
    public void test_selectList_query_queryForeign_on() {
        ...
        for (Integer memberId : notExistsMemberIdList) {
            if (memberWithdrawalBhv.selectByPK(memberId) != null) {
                markHere("exists");
            }
        }
        assertMarked("exists");
